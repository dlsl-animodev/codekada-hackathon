...
export default function EndingPage() {
    return (
        ...
        >
            ...
            <div className="bg-gradient-to-br from-black/20 to-black/20 backdrop-blur-xl border-2 border-white/10 shadow-2xl p-8 rounded-2xl max-w-4xl flex flex-col items-center justify-center">
                <h1 className="text-center text-3xl sm:text-5xl md:text-6xl font-bold bg-gradient-to-r from-white via-[#FAC638] to-white bg-clip-text text-transparent leading-tight mb-2">
                    The Case of the
                    <br />
                    <span className="text-[#FAC638]">Vanished Heirloom</span>
                </h1>
                <p className="text-xs sm:text-base md:text-lg max-w-2xl leading-relaxed mb-8">
                ...
                <div>
                    ...
                    <p className="text-xs md:text-base text-slate-200">
                ...
                <p className="text-xs md:text-base">By x-03 from De La Salle Lipa :D</p>
